...
//    => optionsBuilder.UseSqlServer("data source=DESKTOP-NBK96KP\\SQLEXPRESS;initial catalog=GARAS;integrated security=True;MultipleActiveResultSets=True;TrustServerCertificate=True");
  ...
  //  public virtual DbSet<BompartitionHistory> BompartitionHistories { get; set; }
   ...
   // public virtual DbSet<BompartitionItemAttachment> BompartitionItemAttachments { get; set; }
    ...
    //public virtual DbSet<GarasAPP.Core.Models.Task> Tasks { get; set; }
    ...
    //public virtual DbSet<VTestPurchasePoSupplierAccount> VTestPurchasePoSupplierAccounts { get; set; }
    ...
    //        entity.HasOne(d => d.AbsenceType).WithMany(p => p.Attendances).HasConstraintName("FK_Attendance_ContractLeaveSetting");
    //    });
    ...
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_BankDetail_User3");
    //    });
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.Global).HasDefaultValueSql("((1))");
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.ActiveToUse).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.AlternativeItem).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.IsAlternative).HasDefaultValueSql("((1))");
    ...
    //        entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.BranchModifiedByNavigations).HasConstraintName("FK_Branch_Governorate");
    //    });
    ...
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_BranchDepartment_Branch");

    //        entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.BranchDepartmentCreatedByNavigations)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_BranchDepartment_User");

    //        entity.HasOne(d => d.Department).WithMany(p => p.BranchDepartments)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_BranchDepartment_Department");

    //        entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.BranchDepartmentModifiedByNavigations).HasConstraintName("FK_BranchDepartment_User1");
    //    });
    ...
    //    {
    //        entity.Property(e => e.HasLogo).HasDefaultValueSql("((0))");
    ...
    //    {
    //        entity.Property(e => e.Isautomatic).HasDefaultValueSql("((1))");
    ...
    //        entity.HasOne(d => d.User).WithMany(p => p.ContractDetailUsers)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_ContractDetails_User");
    //    });
    ...
    //        entity.HasOne(d => d.User).WithMany(p => p.ContractLeaveEmployeeUsers)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_ContractLeaveEmployee_User");
    //    });

    //    modelBuilder.Entity<ContractLeaveSetting>(entity =>
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.AllowedPerYearId).IsFixedLength();
    ...
    //        entity.HasOne(d => d.CrmreportReason).WithMany(p => p.Crmreports)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_CRMReport_CRMReportReason");
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.IsLocal).HasDefaultValueSql("((0))");
    //    });
    ...
    //        entity.HasOne(d => d.User).WithMany(p => p.GroupUserUsers)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.IsDeduction).HasDefaultValueSql("((1))");
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.MaxBalance).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.MaxBalance1).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.MinBalance).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.MinBalance1).HasDefaultValueSql("((0))");
    ...
    //    {
    //        entity.Property(e => e.FromBom).HasDefaultValueSql("('FALSE')");
    //        entity.Property(e => e.PurchaseQuantity).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.PurchaseQuantity1).HasDefaultValueSql("((0))");
    ...
    //        entity.Property(e => e.HoldQty).HasDefaultValueSql("((0))");
    ...
    //    {
    //        entity.HasKey(e => e.Id).HasName("PK__Notifica__3214EC2749B8F5D6");
    //    });
    ...
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_POApprovalUser_POApprovalSetting");
    //    });
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.BompriceTotal).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.QuantityTotal).HasDefaultValueSql("((0))");
    ...
    //    {
    //        entity.Property(e => e.SalesManagerAddPrice).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.SalesManagerAddPricePercentage).HasDefaultValueSql("((0))");
    ...
    //        entity.HasOne(d => d.SalesOfferProduct).WithMany(p => p.ProjectFabricationBoqs).HasConstraintName("FK__ProjectFa__Sales__71A9618D");
    //    });
    ...
    //        entity.HasOne(d => d.SalesOfferProduct).WithMany(p => p.ProjectInstallationBoqs).HasConstraintName("FK__ProjectIn__Sales__729D85C6");
    //    });
    ...
    //        entity.Property(e => e.TimeTracking).HasDefaultValueSql("((1))");
    ...
    //        entity.Property(e => e.TimeTracking).HasDefaultValueSql("((0))");
    ...
    //        entity.HasOne(d => d.Currency).WithMany(p => p.PrsupplierOfferItems).HasConstraintName("FK__PRSupplie__Curre__25B31578");
    ...
    //        entity.HasOne(d => d.PaymentMethod).WithMany(p => p.Salaries)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_Salary_PaymentMethod");

    //        entity.HasOne(d => d.PaymentStrategy).WithMany(p => p.Salaries)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_Salary_PaymentStrategy");

    //        entity.HasOne(d => d.User).WithMany(p => p.SalaryUsers)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    ...
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_SalesBranchProductTarget_Product");
    ...
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_SalesBranchUserProductTarget_Product");
    ...
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.ClientApprove).HasDefaultValueSql("((0))");
    ...
    //    modelBuilder.Entity<GarasAPP.Core.Models.Task>(entity =>
    //    {
    //        entity.Property(e => e.Active).HasDefaultValueSql("((1))");
    ...
    //    {
    //        entity.Property(e => e.Eapprove).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.Status).HasDefaultValueSql("((1))");
    //        entity.Property(e => e.TimeTracking).HasDefaultValueSql("((1))");
    ...
    //    {
    //        entity.Property(e => e.Billable).HasDefaultValueSql("((0))");
    //        entity.Property(e => e.Eapproval).HasDefaultValueSql("((0))");
    ...
    //        entity.HasOne(d => d.User).WithMany(p => p.UserTeamUsers)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    ...
    //    {
    //        entity.Property(e => e.AtWork).HasDefaultValueSql("((1))");
    ...
    //    modelBuilder.Entity<VTestPurchasePoSupplierAccount>(entity =>
    //    {
    //        entity.ToView("V_TestPurchasePO_SupplierAccount");
    //    });
    ...
    //        entity.HasOne(d => d.JobOrderProject).WithMany(p => p.VehicleMaintenanceJobOrderHistories)
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_VehicleMaintenanceJobOrderHistory_Project");
    ...
    //            .OnDelete(DeleteBehavior.ClientSetNull)
    //            .HasConstraintName("FK_ClientVehicle_Client");
