...
public partial class InventoryMatrialReleaseItem
{
    ...
    public virtual InventoryMatrialRelease InventoryMatrialReleaset { get; set; } = null!;

    [ForeignKey("InventoryMatrialRequestItemId")]
    [InverseProperty("InventoryMatrialReleaseItems")]
    public virtual InventoryMatrialRequestItem InventoryMatrialRequestItem { get; set; } = null!;
}
