...
public partial class InventoryItem
{
    ...
    public virtual InventoryItemCategory InventoryItemCategory { get; set; } = null!;
    ...
    public virtual InventoryUom PurchasingUom { get; set; } = null!;

    [ForeignKey("RequstionUomid")]
    [InverseProperty("InventoryItemRequstionUoms")]
    public virtual InventoryUom RequstionUom { get; set; } = null!;
