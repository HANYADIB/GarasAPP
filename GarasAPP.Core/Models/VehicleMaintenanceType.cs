...
public partial class VehicleMaintenanceType
{
    ...
    [InverseProperty("VehicleMaintenanceTypes")]
    public virtual VehicleMaintenanceTypePriorityLevel VehiclePriorityLevel { get; set; } = null!;

    [ForeignKey("VehicleRateId")]
    [InverseProperty("VehicleMaintenanceTypes")]
    public virtual VehicleMaintenanceTypeRate VehicleRate { get; set; } = null!;
}
