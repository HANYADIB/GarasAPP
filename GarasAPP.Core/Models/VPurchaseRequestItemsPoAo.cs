...
public partial class VPurchaseRequestItemsPoAo
{
    ...
    [StringLength(50)]
    public string PurchaseRequestStatus { get; set; } = null!;
    ...
    [Column("PurchasePOItemActualUnitPrice", TypeName = "decimal(18, 2)")]
    public decimal? PurchasePoitemActualUnitPrice { get; set; }

    [Column("PurchasePOItemFinalUnitCost", TypeName = "decimal(18, 2)")]
    public decimal? PurchasePoitemFinalUnitCost { get; set; }

    [Column("PurchasePOItemTotalActualPrice", TypeName = "decimal(18, 2)")]
